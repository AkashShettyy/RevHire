...
function Landing() {
  return (
    <div className="app-shell">
      <div className="absolute top-0 right-0 -mr-40 h-[600px] w-[600px] rounded-full bg-brand-300/25 blur-[120px] pointer-events-none"></div>
      <div className="absolute left-[-8rem] top-[12rem] h-[420px] w-[420px] rounded-full bg-cyan-200/20 blur-[120px] pointer-events-none"></div>
      
      <section className="relative pt-8 pb-16 sm:pt-12 sm:pb-24">
        <div className="layout-container">
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative z-10">
              <span className="mb-6 inline-flex items-center gap-2 rounded-full border border-brand-200 bg-white/90 px-4 py-1.5 shadow-sm">
              ...
              <div className="mt-12 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div key={item.label} className="premium-card border-surface-300 bg-white/95 px-5 py-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-brand-200 hover:shadow-md">
            ...
            <div className="relative z-10 w-full lg:ml-auto">
              <div className="premium-card overflow-hidden border border-surface-200 bg-white/90 p-3 shadow-md shadow-surface-900/10">
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-brand-50 via-white to-cyan-50 p-9 text-surface-900">
                  ...
                  <h2 className="mt-3 text-[30px] font-bold font-display leading-tight">What users can do today</h2>
                ...
                <div className="mt-3 space-y-3 p-5">
                  {capabilityGroups.map((group) => (
                    <div key={group.title} className="rounded-xl border border-surface-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-brand-200 hover:shadow-md">
      ...
      <section className="relative border-y border-surface-200/70 bg-white/70 py-24">
        <div className="layout-container">
          <div className="max-w-2xl mx-auto text-center">
            <span className="inline-flex rounded-full border border-surface-200 bg-white px-3 py-1 text-xs font-bold uppercase tracking-normal text-surface-600">Product Overview</span>
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {productNotes.map((item, i) => (
              <article key={item.title} className="premium-card bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-brand-200 hover:shadow-md">
      ...
      <section className="relative py-24">
        <div className="layout-container">
          <div className="relative overflow-hidden rounded-xl border border-brand-200 bg-gradient-to-br from-white via-brand-100 to-cyan-100 px-8 py-18 text-center text-surface-900 shadow-lg shadow-brand-100/60 sm:px-14">
